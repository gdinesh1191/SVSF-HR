                        ...
                        <div class="space-y-4 lg:border-r lg:border-gray-300 lg:pr-4 mt-4">
                          ...
                          <div class="flex flex-col sm:flex-row sm:items-start gap-2 ">
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-start gap-2">
                                ...
                                <input type="date" class="h-[35px] px-[0.75rem] py-[0.375rem] text-[#212529]
                                text-sm bg-white border border-[#cbcbcb] rounded-md leading-[1.5]
                                focus:outline-none focus:border-[#009333] sm:w-2/3 w-full" />
                            </div>
...
<option value="KOTAK">Kotak Mahindra Bank</option>
  ...
  <table class="w-full text-sm">
    <thead class="bg-[#f8f9fa] text-left text-[#12344d] text-[12px] sticky top-0 z-10 border-b border-[#ebeff3]  ">
      <tr>
    ...
    <tbody>
      <tr>
        ...
        <td class="p-2 border-r border-b border-[#ebeff3]">
          <input type="text" id="aadhaar" maxlength="12" placeholder="Enter Aadhar Number" class="h-[35px] px-[0.75rem] py-[0.375rem] text-[#212529] 
                    text-sm placeholder:text-[#585858] bg-white border border-[#cbcbcb] 
                    rounded-md leading-[1.5] focus:outline-none focus:border-[#009333] 
                     w-full">
